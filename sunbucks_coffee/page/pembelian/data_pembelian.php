...
function load() {
    ...
    xhttp.open("GET", "http://localhost/coffee/sunbucks_coffee/page/pembelian/data_pembelian.php", true);
...
function insert() {
    ...
    if(no != ''){
        ...
        var data = { no : no};
        var xhttp = new XMLHttpRequest();
        xhttp.open("POST", "http://localhost/coffee/sunbucks_coffee/page/produk/data_produk.php", true);
...
function edit(id_pembeli) {
    var id_pembeli = document.getElementById('id_pembeli');
    ...
    var xhttp = new XMLHttpRequest();
    xhttp.open("GET", "http://localhost/coffee/sunbucks_coffee/page/produk/data_produk.php?id_kategori="+id_kategori, true);
